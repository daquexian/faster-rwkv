...
namespace cuda
{
	...
	inline __device__ rwkv::LengthType indices_to_offset(const rwkv::LengthType* shape, 
								const rwkv::LengthType* indices, int ndim) {
	...
	inline __device__ void offset_to_indices(rwkv::LengthType offset, const rwkv::LengthType* shape, 
								rwkv::LengthType* indices, rwkv::LengthType total, int ndim) {
