...
sleep 1
aria2c -c -x16 -s16 https://github.com/daquexian/faster-rwkv/releases/download/latest/chat-android -o chat
chmod +x chat
...
if (( $ARG >= 1 )); then
    ...
    echo 'FR_SHOW_SPEED=1 ./chat world_tokenizer RWKV-5-World-0.1B-v1-20230803-ctx4096-ncnn-int8 "ncnn auto"' > run_0.1b_int8.sh
...
if (( $ARG >= 3 )); then
    ...
    echo 'FR_SHOW_SPEED=1 ./chat world_tokenizer RWKV-4-World-CHNtuned-1.5B-v1-20230620-ctx4096-ncnn-int8 "ncnn auto"' > run_1.5b_int8.sh
